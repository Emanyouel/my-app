...
const Dashboard = () => {
  ...
  useEffect(() => {
    API.get("/bookings/salon").then((res) => {
    ...
    <div className="min-h-screen bg-gray-200">
      ...
      <div className="px-10 mt-8">
        <div className="relative rounded-2xl overflow-hidden">
          <div className="w-full h-[520px] object-cover bg-[url('https://images.pexels.com/photos/7518736/pexels-photo-7518736.jpeg')] bg-fixed bg-center bg-cover"></div>
